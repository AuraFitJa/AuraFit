...
.hero-layout{display:grid;grid-template-columns:1.6fr .9fr;gap:16px;align-items:stretch}.hero-title{margin:12px 0 10px;font-size:clamp(34px,4vw,52px);line-height:1.02;letter-spacing:-.03em}.hero-sub{margin:0;color:#cbd5e1;font-size:17px;max-width:72ch;line-height:1.5}.hero-support{display:grid;gap:12px}.hero-mini{border:1px solid rgba(255,255,255,.1);border-radius:22px;padding:16px;background:rgba(255,255,255,.04)}.hero-mini h4{margin:0 0 7px;font-size:12px;text-transform:uppercase;letter-spacing:.08em;color:#94a3b8}.hero-mini p{margin:0;font-size:15px;color:#e2e8f0;line-height:1.35}
...
<article class="hero-redesign"><div class="hero-layout"><div><span class="pill">Home dashboard</span><h1 class="hero-title">Ciao, <?= h($displayName) ?></h1><p class="hero-sub">Vista professionista completa e scalabile per gestione clienti, ID-Key, piani di allenamento/nutrizione, monitoraggio progressi e reportistica. Tutto il controllo operativo della tua giornata in un unico spazio.</p></div><div class="hero-support"><div class="hero-mini"><h4>Focus oggi</h4><p><?= h((string)$overview['clientiAttivi']) ?> clienti attivi da seguire con <?= h((string)$overview['idKeyDisponibili']) ?> ID-Key subito disponibili.</p></div><div class="hero-mini"><h4>Snapshot dashboard</h4><p>Piano <?= h((string)$overview['piano']) ?>, rinnovo <?= h((string)$overview['rinnovo']) ?> e stato account <?= h((string)$overview['pianoStato']) ?>.</p></div></div></div></article>
