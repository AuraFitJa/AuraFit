...
function renderEnd(string $scripts = ''): void {
  ...
  $tabs = [
    ...
    'allenamenti' => ['label' => 'Workout', 'href' => 'allenamenti.php', 'visible' => $isPt],
