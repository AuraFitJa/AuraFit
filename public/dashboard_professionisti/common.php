...
function renderStart(string $title, string $activeTab, string $email, string $roleBadge, bool $isPt, bool $isNutrizionista): void {
  ...
  echo '@media (max-width:760px){.container{padding:0 12px}.topbar{position:static}.nav{min-height:64px;flex-wrap:wrap;justify-content:center;padding:10px 0}.brand{width:100%;justify-content:center;font-size:16px}.nav-actions{width:100%;justify-content:center;flex-wrap:wrap}.nav-actions .btn,.nav-actions .pill{flex:1 1 160px;max-width:220px}.layout{padding:12px 0 24px;gap:12px}.side{padding:8px;background:transparent;box-shadow:none;border-radius:0}.menu{display:flex;gap:8px;overflow-x:auto;padding-bottom:2px;scrollbar-width:thin}.menu a{white-space:nowrap;background:rgba(255,255,255,.05);border-color:rgba(255,255,255,.08);padding:9px 12px}.card{padding:14px;border-radius:14px}.hero{padding:16px}.toolbar{flex-direction:column;align-items:stretch}.toolbar .btn{width:100%}.profile-modal{padding:10px}.profile-modal-card{padding:14px;border-radius:16px}.profile-modal-grid{grid-template-columns:1fr}}';
