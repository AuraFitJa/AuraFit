...
function renderStart(string $title, string $activeTab, string $email, string $roleBadge, bool $isPt, bool $isNutrizionista): void {
  ...
  echo '.nav{display:flex;align-items:center;justify-content:space-between;min-height:74px;gap:12px}.brand{display:inline-flex;align-items:center;font-weight:700;letter-spacing:.01em;font-size:18px;color:#f5f8ff;padding:8px 14px;border-radius:12px;border:1px solid rgba(255,255,255,.14);background:rgba(255,255,255,.03);box-shadow:0 10px 28px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.06)}.brand::after{content:"";display:block;width:26px;height:1px;margin-left:10px;background:rgba(255,255,255,.28)}';
