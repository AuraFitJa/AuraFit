...
Database::exec('DELETE o FROM QuestionarioOpzioni o INNER JOIN QuestionarioDomande d ON d.idDomanda=o.domanda INNER JOIN Questionari q ON q.idQuestionario=d.questionario WHERE o.idOpzione=? AND q.professionista=?',[$idOpzione,$ctx['professionistaId']]);
