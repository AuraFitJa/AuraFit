...
function renderStart(string $title, string $activeTab, ?string $email): void {
  ...
  echo '.nav{display:flex;align-items:center;justify-content:space-between;min-height:74px;gap:12px}.brand{display:inline-flex;align-items:center;font-weight:800;font-size:30px;letter-spacing:.01em;color:#f8fbff;padding:10px 16px;border-radius:12px;border:1px solid rgba(255,255,255,.16);background:rgba(10,18,36,.72);box-shadow:0 10px 26px rgba(0,0,0,.34)}';
