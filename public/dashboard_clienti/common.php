  ...
  try {
    ...
    $duplicate = Database::exec(
      'SELECT idUtente FROM Utenti
       ...
       LIMIT 1',
      [(int)$user['idUtente'], $emailInput, $emailNormalized]
    )->fetch();
    ...
    Database::exec(
      'UPDATE Utenti
       ...
       WHERE idUtente = ?',
      [$nomeInput, $cognomeInput, $emailInput, $emailNormalized, (int)$user['idUtente']]
    );
